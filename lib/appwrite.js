...
export const COLLECTIONS = {
    ...
    STUDY_TRIP_SITES: process.env.NEXT_PUBLIC_APPWRITE_STUDYTRIP_SITES_COLLECTION_ID || '',
};
export const BUCKETS = {
    FACILITATOR_DOCUMENTS: process.env.NEXT_PUBLIC_APPWRITE_FACILITATOR_DOCUMENTS_BUCKET_ID || '',
};
