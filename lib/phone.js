...
/** True when the value has enough digits to store as a phone number. */
export function hasMeaningfulPhoneDigits(value) {
    return getPhoneDigitCount(value) >= PHONE_MIN_DIGITS;
}

/** Optional phone inputs: country code alone (e.g. +256) counts as cleared. */
export function isEmptyOptionalPhoneInput(value) {
    return !hasMeaningfulPhoneDigits(value);
}

/** @deprecated Use hasMeaningfulPhoneDigits */
